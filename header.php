							...
							<ul class="details-info">
								...
								<li class="details-info__item">
									...
									<div class="contacts-block__info">
										...
										<a class="text-overflow" href="mailto:rabeet0846551@example.com"
											title="rabeet0846551@example.com">rabeet0846551@example.com</a>
									</div>
								</li>
								<!-- Phone -->
								<li class="details-info__item">
									...
									<div class="contacts-block__info">
										...
										<span class="text-overflow" title="+92 311 0846551">+92 311 0846551</span>
									</div>
								</li>
								<!-- Birthday -->
								<li class="details-info__item">
